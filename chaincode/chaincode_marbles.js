...
let Chaincode = class {
  ...
  async transferMarblesBasedOnColor(stub, args, thisClass) {
    ...
    while (true) {
      ...
      // let method = this['transferMarble'];
      let response = await method(stub, [returnedMarbleName, newOwner]); //TODO: How to call chaincode func
      // if the transfer failed break out of loop and return error
      // if response.status != shim.OK { //TODO: Handle
